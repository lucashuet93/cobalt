output "apim_service_id" {
  ...
  value       = azurerm_api_management.apimservice.id
}

output "apim_gateway_url" {
  description = "The URL of the Gateway for the API Management Service"
  value       = azurerm_api_management.apimservice.gateway_url
}

output "apim_service_public_ip_addresses" {
  description = "The Public IP addresses of the API Management Service"
  value       = azurerm_api_management.apimservice.public_ip_addresses
}
...
output "apim_service_identity_tenant_id" {
  ...
  value       = azurerm_api_management.apimservice.identity[0].tenant_id
}
...
output "apim_service_identity_object_id" {
  ...
  value       = azurerm_api_management.apimservice.identity[0].principal_id
}
